...
def test_add_group(app):
    ...
    app.create_group(Group(name="Name_of_group", header="Header_of_group", footer="Footer_of_group"))
    app.session.logout()
...
def test_add_contact(app):
    app.session.login(username="admin", password="secret")
    app.create_contact(Contact(firstname="Olga", middlename="Petrovna", lastname="Petrova", nickname="Star", title="economist", company="OAO Dream-House",
